      ...
      <div className={`md:hidden fixed top-16 left-0 w-full bg-black bg-opacity-95 backdrop-blur-md transition-all duration-300 ease-in-out ${isMenuOpen ? 'opacity-100 visible' : 'opacity-0 invisible'}`}>
        <div className="flex flex-col items-center py-8 space-y-6">
          <ul className="flex flex-col items-center gap-6 text-gray-200 font-medium text-lg">
            <li><a href="/" onClick={closeMenu} className="hover:text-blue-400 transition">Accueil</a></li>
            <li><a href="#features" onClick={closeMenu} className="hover:text-blue-400 transition">Fonctionnalités</a></li>
            <li><a href="/pricing" onClick={closeMenu} className="hover:text-blue-400 transition">Tarifs</a></li>
          </ul>
