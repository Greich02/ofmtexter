...
function AIDashboardAnimation() {
  ...
  return (
    <div className="bg-gradient-to-tr from-blue-900 via-blue-400 to-blue-900 rounded-2xl p-0 shadow-2xl w-[370px] md:w-[420px] h-[220px] flex flex-col justify-start items-center relative border-2 border-blue-400" id="/home" >
      ...
      <div className="flex-1 w-full px-6 py-4 flex flex-col justify-center">
        <div className="text-xs text-blue-200 font-mono mb-2">Prompt :</div>
        <div className="bg-[#181f3a] rounded-lg px-3 py-2 text-blue-100 font-mono text-sm shadow-blue-glow border border-blue-500 mb-4 animate-fade-in">
          {prompt}
        </div>
        <div className="text-xs text-blue-200 font-mono mb-2">Réponse IA :</div>
        <div className="bg-[#232346] rounded-lg px-3 py-2 text-blue-100 font-mono text-base shadow-blue-glow border border-blue-500 min-h-[32px] animate-fade-in">
...
export default function HeroSection() {
  ...
  return (
    <section className="pt-16 pb-20 px-10 flex flex-col md:flex-row items-center justify-between gap-12 bg-gradient-to-b from-black via-gray-900 to-gray-950">
      <div className="max-w-xl">
        <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-6 flex flex-col ">
